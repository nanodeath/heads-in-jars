...
export const availablePersonas: PersonaDirectory = {
	...
	dev_manager: {
		name: "Jordan",
		description:
			"Development Manager concerned with team productivity and processes",
		persona:
	...
	architect: {
		name: "Morgan",
		description:
			"System Architect who designs scalable and maintainable systems",
		persona:
	...
	marketing_director: {
		name: "Parker",
		description:
			"Marketing Director focused on market positioning and user acquisition",
		persona:
